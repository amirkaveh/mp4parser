...
public class ClippedTrackTest {
    ...
    public void testGetDecodingTimeEntries() throws Exception {
        ...
        Assertions.assertEquals(1, r.get(0).getCount());
        Assertions.assertEquals(3, r.get(0).getDelta());
        r = ClippedTrack.getDecodingTimeEntries(e, 0, 2);
        Assertions.assertEquals(1, r.size());
        Assertions.assertEquals(2, r.get(0).getCount());
        Assertions.assertEquals(3, r.get(0).getDelta());
        ...
        Assertions.assertEquals(1, r.get(0).getCount());
        Assertions.assertEquals(3, r.get(0).getDelta());
        Assertions.assertEquals(1, r.get(1).getCount());
        Assertions.assertEquals(4, r.get(1).getDelta());
        r = ClippedTrack.getDecodingTimeEntries(e, 3, 4);
        Assertions.assertEquals(1, r.size());
        Assertions.assertEquals(1, r.get(0).getCount());
        Assertions.assertEquals(4, r.get(0).getDelta());
        r = ClippedTrack.getDecodingTimeEntries(e, 1, 6);
        Assertions.assertEquals(3, r.size());
        Assertions.assertEquals(1, r.get(0).getCount());
        Assertions.assertEquals(3, r.get(0).getDelta());
        Assertions.assertEquals(3, r.get(1).getCount());
        Assertions.assertEquals(4, r.get(1).getDelta());
        Assertions.assertEquals(1, r.get(2).getCount());
        Assertions.assertEquals(5, r.get(2).getDelta());
        r = ClippedTrack.getDecodingTimeEntries(e, 2, 6);
        Assertions.assertEquals(2, r.size());
        Assertions.assertEquals(3, r.get(0).getCount());
        Assertions.assertEquals(4, r.get(0).getDelta());
        Assertions.assertEquals(1, r.get(1).getCount());
        Assertions.assertEquals(5, r.get(1).getDelta());
    ...
    public void testGetCompositionTimes() throws Exception {
        ...
        Assertions.assertEquals(1, r.size());
        Assertions.assertEquals(1, r.get(0).getCount());
        Assertions.assertEquals(3, r.get(0).getOffset());
        ...
        Assertions.assertEquals(3, r.get(0).getOffset());
        Assertions.assertEquals(1, r.get(1).getCount());
        Assertions.assertEquals(4, r.get(1).getOffset());
        r = ClippedTrack.getCompositionTimeEntries(e, 3, 4);
        Assertions.assertEquals(1, r.size());
        Assertions.assertEquals(1, r.get(0).getCount());
        Assertions.assertEquals(4, r.get(0).getOffset());
        ...
        Assertions.assertEquals(4, r.get(1).getOffset());
        Assertions.assertEquals(1, r.get(2).getCount());
        Assertions.assertEquals(5, r.get(2).getOffset());
        r = ClippedTrack.getCompositionTimeEntries(e, 2, 6);
        Assertions.assertEquals(2, r.size());
        Assertions.assertEquals(3, r.get(0).getCount());
        Assertions.assertEquals(4, r.get(0).getOffset());
        Assertions.assertEquals(1, r.get(1).getCount());
        Assertions.assertEquals(5, r.get(1).getOffset());
